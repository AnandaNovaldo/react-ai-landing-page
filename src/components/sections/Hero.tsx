    ...
    return (
        <section className="relative pt-32 lg:pt-36">
            ...
            <Container className="flex flex-col lg:flex-row gap-10 lg:gap-12">
                ...
                <div className="relative flex flex-col items-center text-center lg:text-left lg:items-start lg:max-w-none max-w-3xl mx-auto lg:mx-0 lg:flex-1 lg:w-1/2">
                    ...
                    <Paragraph className="mt-8">
                        Our AI solutions are designed to help you streamline your operations, enhance customer experiences, and drive growth. Experience a
                        future where your business runs smarter, faster, and more efficiently.
                    </Paragraph>
                ...
                <div className="flex flex-1 lg:w-1/2 lg:h-auto relative lg:max-w-none lg:mx-0 mx-auto max-w-3xl">
                    <img src="https://img.freepik.com/premium-photo/person-using-vr-ar-googles_941097-254348.jpg?ga=GA1.1.374913840.1719116163&w=740"
                    alt="Hero image"
                    width={2200}
                    height={2359}
